              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <td><?php echo $Row_Projet["Design_tache"]; ?></td>
                    <td><?php echo $Row_Projet["Design_projet"]; ?></td>
                      <td><?php echo $Row_Projet["date_debut_tache"]; ?></td>
                    <td><?php echo $Row_Projet["date_fin_tache"]; ?></td>
                    <td><?php echo $Row_Projet["Priorite_tache"]; ?></td>
                     <td>
                       <form method="post" action="index.php">
                        <input type="hidden" name="ci" 
							value="<?php echo $Row_Projet["id_tache_projet"]; ?>" />
