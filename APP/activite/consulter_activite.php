              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <td><?php echo $Row_Projet["Design_activite"]; ?></td>
                      <td><?php echo $Row_Projet["date_debut_activite"]; ?></td>
                    <td><?php echo $Row_Projet["date_fin_activite"]; ?></td>
                    <td><?php echo $Row_Projet["priorite_activite"]; ?></td>
                    <td>
                       <form method="post" action="index.php">
                        <input type="hidden" name="ci" 
							value="<?php echo $Row_Projet["id_activite"]; ?>" />
