...
function GotoHome(){
	window.location = 'form_activite.php?';
}
...
include_once '../Menu_Vert.php';?>
 <!-- Fin top navigation -->
      ...
      <div class="right_col" role="main">
        ...
        <div class="">
          ...
          <div class="row">
            ...
            <input type="hidden" name="id_activite" value="<?php echo (isset($gresult) ? $gresult["id_activite"] :  ''); ?>" />

                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Désignation<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="Design_activite" 
							value="<?php echo (isset($gresult) ? $gresult["Design_activite"] :  ''); ?>"  placeholder="" required type="text">
                      </div>
                    </div>
                   <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
                       <input name="date_debut_activite" type="text" class="form-control has-feedback-left" id="single_cal1" placeholder="Date debut" aria-describedby="inputSuccess2Status" value="<?php echo (isset($gresult) ? $gresult["date_debut_activite"] :  ''); ?>" required>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input name="date_fin_activite" type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="Date fin" aria-describedby="inputSuccess2Status" value="<?php echo (isset($gresult) ? $gresult["date_fin_activite"] :  ''); ?>" required>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Responsable<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php
include '../DBConfig.php';
...
<select style="width:500px; height:30px" class="txt-fld" name="id_user" id="id_user" placeholder="" required>
...
<?php }?>
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="priorite_activite" 
							value="<?php echo (isset($gresult) ? $gresult["priorite_activite"] :  ''); ?>"  placeholder="" required type="text">
                      </div>
                    </div>
