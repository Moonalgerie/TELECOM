              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <td><?php echo $Row_Projet["Adr_client"]; ?></td>
                    <td><?php echo $Row_Projet["Description_client"]; ?></td>
                    <td><?php echo $Row_Projet["Initials_client"]; ?></td>
                    <td><?php echo $Row_Projet["Nom_departement"]; ?></td>
                    <td><?php echo $Row_Projet["Nom_user"]; ?></td>
                    <td>
                       <form method="post" action="index.php">
                        <input type="hidden" name="ci" 
							value="<?php echo $Row_Projet["id_client"]; ?>" />
