...
function GotoHome(){
	window.location = 'form_client.php?';
}
      ...
      <div class="right_col" role="main">
        ...
        <div class="">
          ...
          <div class="row">
            ...
            <input type="hidden" name="ContactID" value="<?php echo (isset($gresult) ? $gresult["id_client"] :  ''); ?>" />
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" name="nom_client" 
							value="<?php echo (isset($gresult) ? $gresult["nom_client"] :  ''); ?>"  placeholder="" required type="text" >
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Adresse
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="occupation8" type="text" name="Adr_client" 
							value="<?php echo (isset($gresult) ? $gresult["Adr_client"] :  ''); ?>" class="optional form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Initials<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="occupation7" type="text"name="Initials_client" 
							value="<?php echo (isset($gresult) ? $gresult["Initials_client"] :  ''); ?>" class="optional form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="item form-group">
...
<?php }?>
                      ...
                      <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Chargé de compte dédié
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php
include '../DBConfig.php';
$a=isset($gresult) ? $gresult["id_user"] :  ''; 
$sql="SELECT * FROM user  where user.id_fonction =  5 ;" ;
$result = mysqli_query($link, $sql);?>
<select style="width:500px; height:30px" class="txt-fld" name="id_user" id="id_user" placeholder="Nom du chargé de compte" required>
...
<?php }?>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="textarea" name="Description_client" class="form-control col-md-7 col-xs-12"><?php echo (isset($gresult) ? $gresult["Description_client"] :''); ?></textarea> 
                      </div>
                    </div>
