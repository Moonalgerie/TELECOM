              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody><?php
while($Row_Activite = mysqli_fetch_array($result_nonlu))
{
?>
						
                      <tr>
                        
                    <td><?php echo $Row_Activite["Design_activite"]; ?></td>
                    <td><?php echo $Row_Activite["priorite_activite"]; ?></td>
                    <td><?php echo $Row_Activite["date_debut_activite"]; ?></td>
                    <td class="center"><?php echo $Row_Activite["date_fin_activite"]; ?></td>
                        
                    <form method="POST" action="../consultation/afficher_activite.php" 
							onSubmit="return ConfirmDelete();"><td>
				<input type="hidden" name="ci" 
			value="<?php echo $Row_Activite["id_activite"]; ?>" />
            ...
            <footer>
              <div class="pull-right">
                Département Développement d'Affaire | ALGERIE TELECOM</a>
              </div>
              <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
