...
//requette afficher le nombre
 $sql2 = "SELECT COUNT(*) as Nbr FROM projet where Etat_projet='0' ";
...
`structure_technique`.`Design_struc`,
...
`projet_fournisseur`.`id_projet` =  `projet`.`id_projet` AND
`projet_structure`.`id_projet` =  `projet`.`id_projet` AND
`projet_structure`.`id_struc` =  `structure_technique`.`id_struc` AND
`user`.`id_fonction`= `fonction`.`id_fonction` AND
`projet`.`Etat_projet`=1  AND  
`user`.`pseudo` =  '".$pseudo."'
";
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li role="presentation" class="dropdown">
                <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                  ...
                  <span class="badge bg-green"><?php echo $rows2['Nbr']; ?></span>
                </a>
        ...
        <div class="">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Projet <small>Non Lu</small></h2>
...
{					
 ?>
                    ...
                    <td class="center"><?php echo $Row_Projet["Description_projet"]; ?></td>
                        <td class="center"><?php echo $Row_Projet["date_debut_projet"]; ?></td>
                         <td><?php echo $Row_Projet["date_fin_projet"]; ?></td>
                           
            <form method="post" action="consulter_projet.php">
                              <td>
