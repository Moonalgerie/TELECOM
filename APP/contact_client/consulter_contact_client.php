                ...
                <div class="x_content">
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr> 
                    <td><?php echo $Row_Projet["nom_contact_client"]; ?></td>
                    <td><?php echo $Row_Projet["prenom_contact_client"]; ?></td>
                    <td><?php echo $Row_Projet["email_contact_client"]; ?></td>
                    <td><?php echo $Row_Projet["tel_contact_client"]; ?></td>
                    <td><?php echo $Row_Projet["adr_contact_client"]; ?></td>
                    <td><?php echo $Row_Projet["nom_client"]; ?></td>
                    <td>
                       <form method="post" action="index.php">
                        <input type="hidden" name="ci" 
							value="<?php echo $Row_Projet["id_contact_client"]; ?>" />
