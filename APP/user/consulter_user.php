              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <td><?php echo $Row_Projet["contact_name"]; ?></td>
                    <td><?php echo $Row_Projet["Tel_user"]; ?></td>
                    <td><?php echo $Row_Projet["Email_user"]; ?></td>
                    <td><?php echo $Row_Projet["Design_fonction"]; ?></td>
                    <td><?php echo $Row_Projet["pseudo"]; ?></td>
                    <td><?php echo $Row_Projet["Nom_departement"]; ?></td>
                     <td><?php echo $Row_Projet["Design_fonction"]; ?></td>
                    <td>
                       <form method="post" action="index.php">
                        <input type="hidden" name="ci"
							value="<?php echo $Row_Projet["id_user"]; ?>" />
